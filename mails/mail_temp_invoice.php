...
<table class"table" > 
  <tr>
    <td>Amount</td>
    <td>N<span>'.$result->amountpaid.'</span></td>
  </tr>
  <tr>
  ...
  <tr>
    <td>Plan Name</td>
    <td><span>'.$result->datasize.'</span></td>
  </tr>
  <tr>
    <td>Status</td>
    <td><span>'.$result->status.'</span></td>
  </tr>
</table></span>Transaction Receipt</p>
                ...
                <table class="email-footer" align="center" width="570" cellpadding="0" cellspacing="0" role="presentation" style="width: 570px; -premailer-width: 570px; -premailer-cellpadding: 0; -premailer-cellspacing: 0; text-align: center; margin: 0 auto; padding: 0;">
                  <tr>
                    <td class="content-cell" align="center" style="word-break: break-word; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; font-size: 16px; padding: 45px;">
                      <p class="f-fallback sub align-center" style="font-size: 13px; line-height: 1.625; text-align: center; color: #A8AAAF; margin: .4em 0 1.1875em;" align="center">© 2022 <span> '.$web['name'].'</span> All rights reserved.</p>
