                  ...
                  <tr>
                    <td class="content-cell" style="word-break: break-word; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; font-size: 16px; padding: 45px;">
                      <div class="f-fallback">
                        <h1 style="margin-top: 0; color: #333333; font-size: 22px; font-weight: bold; text-align: left;" align="left">Hello.  <span>' .$username. ' Has Just Made a Transaction, However; the transaction was not successful</span>,</h1>
                        <p style="font-size: 16px; line-height: 1.625; color: #51545E; margin: .4em 0 1.1875em;">Transaction Response:
                        <p>
                        <span><table class"table" >
  
  <tr>
    <td>Error</td>
    <td><span>'.$result->message.'</span></td>
  </tr>
   </span><p> </p>. This is the transaction reciept</p>
